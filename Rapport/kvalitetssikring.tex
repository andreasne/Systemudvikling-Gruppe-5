...
Security/sikkerhed: \\
Systemet: Kan systemet ødelægges \\
Brugeren: Er brugerens data sikret. \\

Reliability/pålidelighed: \\
Systemet: Er systemet stabilt. \\
Appen: Kan brugeren stole på informationen. \\

Resilience/modstandsdygtigt: \\
Systemet: Kan komme op at køre hurtigt igen efter problemer. \\

Robustness/robust: \\
Systemet: Stabilt og crasher ikke. \\
Database: Kan håndtere forespørgsler. \\

Testability/testbart: \\
App: Funktionaliteten er testbar som sikrer usability. \\

Adaptability/tilpasseligt: \\
Systemet: Kan tilpasses i forhold til udvikling af nyt system eller kravsændringer. \\

Modularity/modulært:\\ 
Systemet: Nødvendighed for adaptability og scalability.\\
