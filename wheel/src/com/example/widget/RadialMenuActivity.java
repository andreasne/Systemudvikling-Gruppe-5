...
import com.example.model.IngredientBasket;
...
/*				try {
	   ...
	   // Sweets
	   public static class Menu4 implements RadialMenuEntry
	   {
	   ...
	   // Milk products
	   public static class Menu5 implements RadialMenuEntry
	   {
	   ...
	   // Grains
	   public static class Menu6 implements RadialMenuEntry
	   {
	   ...
	   // Alcohol
	   public static class Menu7 implements RadialMenuEntry
	   {
	   ...
	   public static class ItemCircle implements RadialMenuEntry
	   {
	   ...
	   public static class Item1Circle extends Basket implements RadialMenuEntry
	   {
	   ...
	   public static class Item2Circle extends Basket implements RadialMenuEntry
	   {
	   ...
	   public static class Item3Circle extends Basket implements RadialMenuEntry
	   {
	      public String getName() { return "Item3Circle"; } 
